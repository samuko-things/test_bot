...
def generate_launch_description():
    ...
    slam_localization_param_file = os.path.join(nav_pkg_path,'config','my_localizer_params_online_async.yaml')
    start_slam_toolbox_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [slam_launch_file]
        ),
        launch_arguments={'use_sim_time': use_sim_time,
                          'slam_params_file': slam_localization_param_file}.items()
        )
